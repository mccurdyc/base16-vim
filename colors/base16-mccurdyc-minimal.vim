...
call <sid>hi("CursorLine",    "", s:gui09, "", s:cterm09, "none", "")
call <sid>hi("CursorLineNr",  s:gui08, s:gui01, s:cterm08, s:cterm01, "", "")
call <sid>hi("QuickFixLine",  "", s:gui0A, "", s:cterm0A, "bold", "")
call <sid>hi("PMenu",         s:gui0C, s:gui09, s:cterm0C, s:cterm09, "none", "")
call <sid>hi("PMenuSel",      s:gui0B, s:gui0A, s:cterm0B, s:cterm0A, "bold", "")
