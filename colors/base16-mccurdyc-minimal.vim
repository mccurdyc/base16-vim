...
call <sid>hi("Folded",        s:gui06, s:gui07, s:cterm06, s:cterm07, "", "")
...
call <sid>hi("Visual",        "", s:gui0A, "", s:cterm0A, "", "")
...
call <sid>hi("CursorLine",    s:gui08, s:gui01, s:cterm08, s:cterm01, "bold", "") " PMenu select
call <sid>hi("CursorLineNr",  s:gui0A, s:gui08, s:cterm0A, s:cterm08, "", "")
call <sid>hi("QuickFixLine",  "", s:gui0A, "", s:cterm0A, "bold", "")
call <sid>hi("PMenu",         s:gui0C, s:gui09, s:cterm0C, s:cterm09, "none", "")
call <sid>hi("PMenuSel",      s:gui08, s:gui0A, s:cterm08, s:cterm0A, "none", "")
